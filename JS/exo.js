...
let objLinea = JSON.parse(localStorage.getItem("objJson"));

console.log(objLinea);

objLinea = localStorage.Tauxabsorption;

div1 = elt.getElementsByTagName("div")[0];
div1.innerHTML = "le taux d'absorption est de" + objLinea;
